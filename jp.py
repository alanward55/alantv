...
print("  \'========================================.  ")
print("  |Penilik: Alan Ward    |Asli Indonesia   | ")
...
print('Copas salah satu link diatas ke browser\n\n\n')
print (r+"Terimakasih telah menggunakan script ini"+w)
print (r+'Copyright \N{COPYRIGHT SIGN} 2021 | Alan Ward')
